...
```
https://github.com/TRANTHAINGUYENDEVDEVELOPER117-GOCODER/Tran-Thai-Nguyen-fcj-internship-report.git
```
...
3. Đặt tên repository: `Tran-Thai-Nguyen-fcj-internship-report`
4. Chọn **Public**
...
git branch -M main
git remote add origin https://github.com/TRANTHAINGUYENDEVDEVELOPER117-GOCODER/Tran-Thai-Nguyen-fcj-internship-report.git
...
- Link tiếng Việt: `https://tranthainguyendevdeveloper117-gocoder.github.io/Tran-Thai-Nguyen-fcj-internship-report/vi/`
