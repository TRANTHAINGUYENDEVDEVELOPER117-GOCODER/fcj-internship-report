...
Ví dụ: `https://tranthainguyen.github.io/TRANTHAINGUYEN-fcj-internship-report/vi/`
...
3. Đặt tên repository: `TRANTHAINGUYEN-fcj-internship-report`
4. Chọn **Public**
...
Thay `<GITHUB_USERNAME>` bằng tài khoản GitHub của bạn:
...
git branch -M main
git remote add origin https://github.com/<GITHUB_USERNAME>/TRANTHAINGUYEN-fcj-internship-report.git
...
- Link tiếng Việt: `https://<GITHUB_USERNAME>.github.io/TRANTHAINGUYEN-fcj-internship-report/vi/`
