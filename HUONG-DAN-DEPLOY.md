...
Ví dụ: `https://tranthainguyen.github.io/fcj-internship-report/vi/`
...
3. Đặt tên (gợi ý): `fcj-internship-report` hoặc `workshop-fcj-2026`
4. Chọn **Public**
...
Thay `<GITHUB_USERNAME>` và `<TEN_REPO>` bằng tài khoản và tên repo của bạn:

```powershell
cd "c:\Users\Lenovo\Downloads\fcj-workshop-template-main\fcj-workshop-template-main"
...
- Link tiếng Việt: `https://<GITHUB_USERNAME>.github.io/<TEN_REPO>/vi/`
